...
const CANDIDATE = hashTarball(Buffer.from('sallyport candidate tarball', 'utf8'));
const RECEIPT = hashTarball(Buffer.from('sallyport candidate receipt', 'utf8'));
...
export function unsignedPrereleaseReceipt(): CandidateReceipt {
    ...
    return {
        ...receipt,
        repository: { ...receipt.repository, name: 'zsumz/sallyport', defaultBranch: 'main' },
        source: {
            ...receipt.source,
            tag: 'v2.0.0-alpha.10',
            signed: false,
