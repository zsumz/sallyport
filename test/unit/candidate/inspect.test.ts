...
const KNOWN_VECTOR = Buffer.from('quoin', 'utf8');
const KNOWN_SHA256 = '4506e80122183dc4e7eba2c4e7ebece9bf3afa923ee1cd409f07883bc23806ea';
const KNOWN_SHA512 = 'ff77fe11ec4448cf53e9237618fdc3ea5a6e8c3c3cea62fcad579f2c1bac392d'
    + '8a06af2d703b8875480476fccb93441c645e1e897a8b4987e1a430baade00f5e';
const KNOWN_INTEGRITY = 'sha512-/3f+EexESM9T6SN2GP3D6lpujDw86mL8rVefLBusOS2KBq8tcDuIdUgEdvzLk'
    + '0QcZF4eiXqLSYfhpDC6reAPXg==';
...
describe('verifyTarballUnchanged', () => {
    ...
    it('reports every digest that changed', () => {
        ...
        const result = verifyTarballUnchanged({
            before,
            afterBuffer: Buffer.from('quoin!', 'utf8'),
        });
